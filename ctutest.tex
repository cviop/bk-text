...
\chapter{Úvod}
tato práce ze zabývá... ano zabývá se... pyčo
...
\chapter{Návrh systému}
	...
	V samotném návrhu elektroniky sondy bylo možné zvolit jednu ze dvou cest. Níže práce popisuje výhody, nevýhody a možné rizika každé z nich a cestu, která byla zvolena při řešení této práce. Zmíněny jsou jak robustnost řešení, tak možná rizika způsobené lidským faktorem a časová náročnost.
		...
		\begin{table}[]
			...
			\caption{Módy GPS přijímačů u-blox}
				...
				\begin{tabular}[c]{@{}c@{}}Max Position \\ Deviation\end{tabular} \\
				Portable               & 12000 & 310 & 50  & Medium \\
				Stationary             & 9000  & 10  & 6   & Small  \\
				Pedestrian             & 9000  & 30  & 20  & Small  \\
				Automotive             & 6000  & 84  & 15  & Medium \\
				At sea                 & 500   & 25  & 5   & Medium \\
				Airborne \textless{}1g & 50000 & 100 & 100 & Large  \\
				Airborne \textless{}2g & 50000 & 250 & 100 & Large  \\
				Airborne \textless{}4g & 50000 & 500 & 100 & Large 
				\end{tabular}
			\end{table}
		\subsection{Teplotní čidlo}
		\subsection{Tlakové čidlo}
		\subsection{Vlhkostní čidlo}
...
\chapter{Realizace}
	...
	\begin{figure}
		...
		\begin{subfigure}{.49\textwidth}
			\centering
			\includegraphics[width=.8\linewidth]{Figures/ALL_rez_white.png}
			\caption{Řez krytem elektroniky}
			\label{fig:half:sec} 
		\end{subfigure}
		\begin{subfigure}{.49\textwidth}
			\centering
