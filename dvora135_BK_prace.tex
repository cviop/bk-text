...
\chapter{Návrh systému}
	...
	%součástky do -40, nízký tlak (bez elektrolytických kond.), dosah 40+ km
		...
		\subsection{Teplotní a tlakový senzor}
		...
		Vlhkostní senzor byl zvolen CM2322, který je součástí modulu DHT22 Click od firmy \textit{Microelektronika}. Senzor je schopen měřit v rozsahu od -40 do 80~°C a 0 až 100~\% relativní vlhkosti (\url{https://www.farnell.com/datasheets/2618831.pdf}). 
