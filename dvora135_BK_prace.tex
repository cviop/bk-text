...
\chapter{Návrh experimentu}
	Kapitola popisuje teorii využívanou při návrhu experimentu a výběru senzorů. Nakonec popisuje samotný návrh experimentu, díky kterému je možné vytvořit matematický model přenosu radiového signálu a následné ověření modelu se změřenými daty. 
