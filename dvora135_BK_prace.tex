...
\lstdefinestyle{mystyle}{
	...
	showtabs=false,                  
	tabsize=2,
	emph={int,char,double,float,unsigned,void,bool, uint8_t, uint16_t, int8_t, int16_t},
...
% 	Atmosféra představuje plynný obal Země (název pochází z~řečtiny spojením slov: atmos~–~pára, sphaira~–~koule), který svým složením dovoluje organizmům na Zemi žít. Atmosféra též pohlcuje nebezpečné UV záření a~udržuje příznivé klimatické podmínky. 
% Na naší Zemi se atmosféra začala tvořit přibližně 1,5\,miliardy~let po vzniku Země samotné~\cite{web_vznik_zeme}.

% 	\subsection{Dělení atmosféry}
% Vertikálních dělení je větší množství. Atmosféru můžeme dělit podle průběhu teploty vzduchu s~rostoucí nadmořskou výškou (graf\,\ref{obr_tepl_prof_teo}), podle chemického složení vzduchu, podle koncentrace atmosférických iontů a~volných elektronů a~podle ovlivňování jednotlivých vrstev třením o~zemský povrch. Já se však zaměřím na dělení první\,-\,podle závislosti teploty na nadmořské výšce. 

% \begin{figure}[hbtp]
%     \centering
%     \includegraphics[height=10cm]{Figures/Teplotni_profil_moje_bez_vrstev.pdf}
%     \caption{Teplotní profil atmosféry}
%     \label{obr_tepl_prof_teo}
% \end{figure}

% \subsubsection{Troposféra}
% Podle výše popsaného dělení je pro nás první vrstvou troposféra. Její mezní výška nad mořem se liší podle polohy na zemském povrchu: na rovníku z~důvodu zemské rotace přesahuje 18\,km a~směrem k~zemským pólům klesá na 8\,km\,\cite{web_tropo}. V~létě je horní hranice položená výše, než v~zimě. Tato vrstva obsahuje všechnu atmosférickou vodu a~probíhá v ní většina povětrnostních procesů a~dějů. Ty se souhrnně označují jako počasí. Teplota vzduchu této vrstvy s~výškou klesá přibližně o~0,65\,°C~na~každých~100\,m~\cite{web_tropo}.


% \subsubsection{Tropopauza}
% Od vyšších vrstev atmosféry je troposféra oddělena tropopauzou. Bývá zpravidla ve výšce 17-20\,km na rovníku a~8-9\,km na pólech. Definována je jako vrstva, kde je pokles teploty menší než 0,2\,°C~na~každých~100\,m. V~tropopauze dokonce dochází k~oteplení\,-\,teplotní inverzi, která funguje jako poklička, jež například zabraňuje vysokým oblakům dostat se do stratosféry.  Bohužel freony, které rozkládají ozonovou vrstvu, jí procházejí.


% \subsubsection{Stratosféra}
% Další vrstvou atmosféry je stratosféra. Stratosféra se nachází přibližně ve výšce 20-50\,km nad povrchem Země. Na rozdíl od troposféry je stratosféra velmi suchá. V~této vrstvě atmosféry teplota s~přibývající výškou roste a~díky této inverzi ustává pohyb částic mezi stratosférou a~tropopauzou. Proto je stratosféra velmi stabilní vrstvou. Rostoucí teplota je zapříčiněna velkým obsahem ozonu v~této vrstvě. Vyskytuje se zde 90\,\% atmosférického ozonu, který pohlcováním UV záření tuto vrstvu zahřívá.




% \subsubsection{Stratopauza}
% Nad stratosférou se nachází ve výšce přibližně 50-55\,km nad Zemí stratopauza. Jedná se o~přechodovou vrstvu mezi stratosférou a~mezosférou. Stratopauza se vyznačuje rostoucí teplotou s~přibývající výškou. Atmosférický tlak se pohybuje v řádech stovek pascalů a~maximální teplota je kolem -3\,°C~\cite{web_stratopauza}.


% \subsubsection{Mezosféra}
% Mezosféra je široká přibližně 40\,km, je tedy vzdálená 55~až~95\,km od povrchu Země. Tlak se v mezosféře pohybuje od $10^{-3}$~atmosféry do  $10^{-6}$~atmosféry, což odpovídá 100\,Pa~až~100\,mPa~\cite{web_mezo}. Teplota této vrstvy s~rostoucí výškou klesá a~to z~původních 0\,°C až na -90\,°C. Teplota klesá, jelikož se zde nenachází žádná vodní pára a~koncentrace ozonu je minimální.


% \subsubsection{Mezopauza}
% Nad mezosférou se rozprostírá mezopouza. V~mezopauze můžeme naměřit ty nejnižší atmosférické teploty. Nízké teploty jsou způsobeny tím, že zde nejsou téměř žádné částice, které by absorbovaly sluneční záření. Další důvod je stopová přítomnost molekul \ce{CO2}, které mají výrazný chladící efekt. V nižších vrstvách je \ce{CO2} považován za skleníkový plyn vinou pohlcování infračerveného záření, vyzářeného zemským povrchem. Nicméně v mezopauze tento málo koncentrovaný plyn vrstvu ochlazuje radiačním ochlazováním\,-\,vyzařováním tepla do vesmíru~\cite{web_mezo}.

% Minimální teploty kolem -90\,\textdegree C  jsou dosahovány ve výšce 85\,km~\cite{web_mezo}. V této oblasti lze také pozorovat svítící noční oblaka\,-\,nejvýše položená oblaka v atmosféře.


% \subsubsection{Termosféra}
% Termosféra se rozprostírá v~rozmezí 95-690\,km nad Zemí. Teplota zde opět s~výškou roste a~může dosahovat až 2000\,°C~\cite{web_termosfera}, nicméně tuto teplotu již nelze měřit klasickým teplotním čidlem, ale pomocí měření kinetické energie jednotlivých molekul~\cite{kniha_dyn_meteo}. Takto vysoká teplota je zde z~důvodu absorpce vysokoenergetického rentgenového a~UV záření o~vlnové délce $\lambda$\,<\,180\,nm~\cite{web_mezo}. Množství energie slunečního záření pohlcené v~termosféře má za následek jak změny šířky pásma termosféry, tak teploty v~ní. V~této vrstvě také vzniká polární záře.
...
Tato kapitola se zabývá samotnou realizací sondy. Popisuje cestu, kterou byla práce směřována při vývoji elektroniky a popisuje výběr jednotlivých komponent. Dále vysvětluje dílčí části firmwaru sondy a způsob, jakým byly řešeny problémy. Popisuje jak vysílací část - sondu, tak přijímací části. Jednak pozemní stanici, která formátovala data do zprávy čitelné anténním trackerem a jednak přijímací software na zobrazení pozice na mapě.
	...
	Aby bylo možné zjisti, jaká část směrové charakteristiky antény byla využita pro přenos dat, bylo nutné zjisti výchylku sondy od svislé osy. Zjištění výchylky sondy lze realizovat metodami jendoduššími a méně přesnějšími, nebo přesnými, sofistikovanými metodami, které ale přesahují rozsah této práce.
...
TODO:
	...
	\begin{figure}[hbtp]
		\centering
		\includegraphics[width=.7\textwidth]{Figures/track_map.PNG}
...
\chapter{Výsledky}
	...
	\begin{figure}
		...
		\caption{Závislost refraktivity na výšce}
		\label{graph:refr}
	\end{figure}
